...
namespace PerfDiff
{
    ...
    {
        public static bool TryCompareETL(string sourceEtlPath, string baselineEtlPath, string sourceSymbolLookupPath, string baselineSymbolLookupPath, out bool regression)
        {
            regression = false;
            CallTree sourceCallTree = GetCallTree(sourceEtlPath, sourceSymbolLookupPath);
            CallTree baselineCallTree = GetCallTree(baselineEtlPath, baselineSymbolLookupPath);
        ...
        private static CallTree GetCallTree(string eltPath, string symbolLookupPath)
        {
            var traceProcess = GetTraceProcessFromETLFile(eltPath);
            var stackSource = CreateStackSourceFromTraceProcess(traceProcess, symbolLookupPath);
